...
all_results2$Interaction_stepwise=results(stepComplexinteraction,FALSE)
...
all_results2$LDA_model=c(0,0,accuracy,Sensitivit,specificit)
...
Sensitivit=round((sensitivity(pred, test$Personal.Loan)),3)
specificit= round((specificity(pred, test$Personal.Loan)),3)
all_results2$qda_2=c(0,0,accuracy,Sensitivit,specificit)
