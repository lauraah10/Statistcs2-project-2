...
# Confusion Matrix
confusionMatrix(class.step, test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.426
                          #  Accuracy    = 0.968
                          #  Sensitivity = 0.7613
                          #  Specificity = 0.9919
...
cm = confusionMatrix(class.lasso, test$Personal.Loan, positive = "Yes")
cm$byClass
                          #  Threshold   = 0.44
                          #  Accuracy    = 0.9633
                          #  Sensitivity = 0.6774
...
confusionMatrix(class.erin, test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.5
                          #  Accuracy    = 0.9593
                          #  Sensitivity = 0.6516
                          #  Specificity = 0.9948
...
confusionMatrix(class.income, test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.3
                          #  Accuracy    = 0.8933
                          #  Sensitivity = 0.5290
                          #  Specificity = 0.9353
...
## Confusion Matrix
confusionMatrix(class.final0, final_test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.4
                          #  Accuracy    = 0.968
                          #  Sensitivity = 0.76774
                          #  Specificity = 0.99108
...
## Confusion Matrix
confusionMatrix(class.final0a, final_test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.33
                          #  Accuracy    = 0.972
                          #  Sensitivity = 0.89677
                          #  Specificity = 0.98067
...
## Confusion Matrix
confusionMatrix(class.final1, final_test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.4
                          #  Accuracy    = 0.9673
                          #  Sensitivity = 0.77419
                          #  Specificity = 0.98959
...
## Confusion Matrix
confusionMatrix(class.final1a, final_test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.33
                          #  Accuracy    = 0.972
                          #  Sensitivity = 0.89677
                          #  Specificity = 0.98067
...
## Confusion Matrix
confusionMatrix(class.final2, final_test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.34
                          #  Accuracy    = 0.974
                          #  Sensitivity = 0.90323
                          #  Specificity = 0.98216
...
## Confusion Matrix
confusionMatrix(class.final2a, final_test$Personal.Loan, positive = "Yes")
                          #  Threshold   = 0.28
                          #  Accuracy    = 0.972
                          #  Sensitivity = 0.91613
                          #  Specificity = 0.97844
...
confusionMatrix(data=pred.final2b, final_test$Personal.Loan, positive = "Yes")
                          #  Accuracy    = 0.9787
                          #  Sensitivity = 0.8516
                          #  Specificity = 0.9933
```
...
# Criteria
fit.p<-predict(LDA.model, newdata=test)$class
confusionMatrix(data=fit.p, test$Personal.Loan, positive = "Yes")
str(fit.p)
